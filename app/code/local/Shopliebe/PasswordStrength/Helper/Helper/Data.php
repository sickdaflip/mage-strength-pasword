...
class Shopliebe_PasswordStrength_Helper_Helper_Data extends Mage_Core_Helper_Abstract 
{
    ...
    public function __construct(){
        $this->setLength(Mage::getStoreConfig('customer/password/password_length'))
            ...
            ->setEmailCheck(Mage::getStoreConfig('customer/password/password_email'));
        return $this;
    }
    ...
    public function setEmailCheck($useEmailCheck)
    {
        $this->_useEmailCheck = $useEmailCheck;
        return $this;
    }
