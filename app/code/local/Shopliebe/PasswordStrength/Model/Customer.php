...
class Shopliebe_PasswordStrength_Model_Customer extends Mage_Customer_Model_Customer
{
    ...
    public function validate()
    {
        ...
        if($validationHelper->getEmailCheck() && $this->getEmail() == $password || $this->getEmail() == strtolower($password)){
            $errors[] = Mage::helper('customer')->__('The password does not the email address. ');
        }
