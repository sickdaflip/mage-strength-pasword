...
class Shopliebe_PasswordStrength_Block_Validation extends Mage_Core_Block_Template
{
    ...
    public function getValidationMessage()
    {
        ...
        $validations = array();
        foreach(array('Case' => 'both uppercase and lowercase characters', 'Number' => 'at least one number', 'SpecialCharacter' => 'at least one special character', 'Email' => 'no use email') as $type => $validation){
